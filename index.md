...
- [Graphs and
  ...
  — graph schemas, constructors, homomorphisms, DOT rendering
- [Undirected wiring
  diagrams](https://catrgory.github.io/catlab/articles/uwd.html) —
...
- [Graph rewriting: DPO, SPO, and
  ...
  algebraic graph transformation with gluing conditions
- [Open systems and typed
...
- [acsets](https://github.com/catRgory/acsets) — Acyclic C-Sets
  (schemas, instances, and morphisms)
