# catlab <img src="man/figures/logo.png" align="right" height="139" alt="" />
...
Built on top of the [acsets](https://github.com/catRgory/acsets) package.
...
- **Finite categories & functors** — `FinCat`, `FinFunctor`, and `ACSetTransformation` with naturality checking
- **Limits & colimits** — `product`, `pullback`, `equalizer`, `coproduct`, `pushout`, `coequalizer`, plus `terminal`/`initial` objects
...
**Simon Frost** ([@sdwfrost](https://github.com/sdwfrost)) — [ORCID 0000-0002-5207-9879](https://orcid.org/0000-0002-5207-9879)
